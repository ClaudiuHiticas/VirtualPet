...
class ToysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create toy" do
    assert_difference('Toy.count') do
      post toys_url, params: { toy: { happiness_bonus: @toy.happiness_bonus, name: @toy.name } }, as: :json
    end
  ...
  test "should update toy" do
    patch toy_url(@toy), params: { toy: { happiness_bonus: @toy.happiness_bonus, name: @toy.name } }, as: :json
    assert_response 200
  end
